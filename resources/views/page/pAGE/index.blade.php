    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          <div class="center">
            <div class="icon"> <img src="{{asset('assets/images/it_service/i1.png')}}" alt="#" /> </div>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          <div class="center">
            <div class="icon"> <img src="{{asset('assets/images/it_service/i2.png')}}" alt="#" /> </div>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          <div class="center">
            <div class="icon"> <img src="{{asset('assets/images/it_service/i3.png')}}" alt="#" /> </div>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30 margin_0">
          <div class="center">
            <div class="icon"> <img src="{{asset('assets/images/it_service/i4.png')}}" alt="#" /> </div>
          </div>
      ...
      <div class="col-md-8">
        <div class="row">
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('assets/images/it_service/si1.png')}}" alt="#" /></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('assets/images/it_service/si2.png')}}" alt="#" /></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('assets/images/it_service/si3.png')}}" alt="#" /></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('assets/images/it_service/si4.png')}}" alt="#" /></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('assets/images/it_service/si5.png')}}" alt="#" /></div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{asset('assets/images/it_service/si6.png')}}" alt="#" /></div>
...
<div class="section padding_layout_1">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
          <div class="product_img"> <img class="img-responsive" src="{{asset('assets/mages/it_service/3.jpg')}}" alt=""> </div>
          <div class="product_detail_btm">
            <div class="center">
              <h4><a href="it_shop_detail.html">Mcafee Livesafe Antivirus</a></h4>
            </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="full blog_colum">
          <div class="blog_feature_img"> <img src="{{asset('assets/images/it_service/post-03.jpg')}}" alt="#" /> </div>
          <div class="post_time">
      ...
      <div class="col-md-4">
        <div class="full blog_colum">
          <div class="blog_feature_img"> <img src="{{asset('assets/images/it_service/post-04.jpg')}}" alt="#" /> </div>
          <div class="post_time">
            <p><i class="fa fa-clock-o"></i> April 16, 2018 ( In Maintenance )</p>
          </div>
          <div class="blog_feature_head">
      ...
      <div class="col-md-4">
        <div class="full blog_colum">
          <div class="blog_feature_img"> <img src="{{asset('assets/images/it_service/post-06.jpg')}}" alt="#" /> </div>
          <div class="post_time">
            <p><i class="fa fa-clock-o"></i> April 16, 2018 ( In Maintenance )</p>
          </div>
          <div class="blog_feature_head">
